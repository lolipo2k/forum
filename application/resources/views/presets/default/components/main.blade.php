    ...
    <div class="forum-card">
        ...
        <div class="card--body">
            ...
            <div class="card-content">
                <a href="{{ route('post.details', slug(@$post->title)) }}">
                ...
                <p class="card-sub-title wyg">{{ substr(strip_tags($post->content), 0, 190) }}
                    @if (strlen(strip_tags($post->content)) > 190)
                        ... <a href="{{ route('post.details', slug(@$post->title)) }}" class="btn-sm p-1"><u>
                                @lang('See More')</u></a>
                    @endif
                </p>
            </div>
            <div class="forum-cad-footer">
                <ul class="footer-item-list">
                    <li>
                        <a href="{{ route('post.details', slug(@$post->title)) }}"><i class="las la-comments"></i>
                    ...
                    <li><a href="{{ route('post.details', slug(@$post->title)) }}"><i class="las la-eye"></i>
